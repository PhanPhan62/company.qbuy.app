        ...
        <div class="row">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= langBaseUrl($page->slug); ?>"><?= esc($page->title); ?></a>
                    </li>
            ...
            <div class="page-content font-text page-text">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="filters text-center">
                            <label data-filter="" class="btn btn-primary active"><input type="radio" name="options">
                                <?= trans("all"); ?></label>
                ...
                <div class="row-masonry">
                    <div id="masonry" class="gallery">
                        ...
                        <div data-filter="category_<?= $item->category_id; ?>"
                            class="col-12 col-sm-6 col-md-3 gallery-item">
                            <div class="item-inner">
                                <a href="<?= $imgBaseURL . $item->path_big; ?>" class="glightbox"
                                    data-glightbox="title: <?= esc($item->title); ?>;">
                                    <img src="<?= $imgBaseURL . esc($item->path_small); ?>"
                                        alt="<?= esc($item->title); ?>" class="img-responsive" />
                                </a>
                            </div>
                        </div>
                        <?php endforeach;
