                            ...
                            <div class="col-12 col-sm-6 col-md-4 gallery-item">
                                <div class="item-inner gallery-image-cover">
                                    <a href="<?= generateURL('gallery_album') . '/' . $item->id; ?>">
                                        ...
                                        <img src="<?= $imgBaseURL . esc($cover->path_small); ?>"
                                            alt="<?= esc($item->name); ?>" class="img-responsive" />
                                        <?php else: ?>
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                            alt="<?= esc($item->name); ?>" class="img-responsive img-gallery-empty" />
                                        <?php endif; ?>
                                        <div class="caption">
                                            <span
                                                class="album-name"><?= esc(characterLimiter($item->name, 100, '...')); ?></span>
                                        </div>
                                    </a>
                                </div>
                            </div>
