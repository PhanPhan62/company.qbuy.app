                    ...
                    <div class="main-slider" id="main-slider">
                        ...
                        <div class="main-slider-item">
                            <a href="<?= generatePostURL($item); ?>" class="img-link" <?php postURLNewTab($item); ?>
                                aria-label="post">
                                <img src="<?= IMG_BASE64_1x1; ?>" data-lazy="<?= getPostImage($item, 'slider'); ?>"
                                    alt="<?= esc($item->title); ?>" class="img-cover" width="687" height="526" />
                ...
                <div class="row gx-1 gy-1">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="item item-large">
                            <a href="<?= generatePostURL($item); ?>" class="img-link" <?php postURLNewTab($item); ?>
                                aria-label="post">
                                <img src="<?= IMG_BASE64_1x1; ?>" data-src="<?= getPostImage($item, 'big'); ?>"
                                    alt="<?= esc($item->title); ?>" class="img-fluid lazyload" width="605"
                                    height="280" />
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="item item-small">
                            <a href="<?= generatePostURL($item); ?>" class="img-link" <?php postURLNewTab($item); ?>
                                aria-label="post">
                                <img src="<?= IMG_BASE64_1x1; ?>" data-src="<?= getPostImage($item, 'slider'); ?>"
                                    alt="<?= esc($item->title); ?>" class="img-fluid lazyload" width="300"
                                    height="242" />
                                <?php getMediaIcon($item, 'media-icon'); ?>
                            </a>
                            <div class="caption">
