    ...
    <div class="modal-dialog modal-dialog-centered modal-login">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-login">
                    <div class="mb-2">
                        <input type="email" name="email" class="form-control form-input input-account"
                            placeholder="<?= trans("email"); ?>" value="<?= old('email'); ?>" required>
                    </div>
                    <div class="mb-2">
                        <input type="password" name="password" class="form-control form-input input-account"
                            placeholder="<?= trans("password"); ?>" value="<?= old('password'); ?>" required>
                    </div>
                    <div class="mb-4 text-end">
                        <a href="<?= generateURL('forgot_password'); ?>"
                            class="link-forget"><?= trans("forgot_password"); ?>?</a>
                    </div>
                            ...
                            <div class="item">
                                <div class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="<?= $activeTheme->theme_color; ?>" class="bi bi-file-earmark-text"
                                        viewBox="0 0 16 16">
                                        <path
                    ...
                    <div class="col-12 col-sm-4 col-add-post">
                        <a href="<?= adminUrl('add-post?type=gallery'); ?>">
                            <div class="item">
                                <div class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="<?= $activeTheme->theme_color; ?>" class="bi bi-images"
                                        viewBox="0 0 16 16">
                    ...
                    <div class="col-12 col-sm-4 col-add-post">
                        <a href="<?= adminUrl('add-post?type=sorted_list'); ?>">
                            <div class="item">
                                <div class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="<?= $activeTheme->theme_color; ?>" class="bi bi-list-ol"
                                        viewBox="0 0 16 16">
                    ...
                    <div class="col-12 col-sm-4 col-add-post">
                        <a href="<?= adminUrl('add-post?type=video'); ?>">
                            <div class="item">
                                <div class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="<?= $activeTheme->theme_color; ?>" class="bi bi-play-circle"
                                        viewBox="0 0 16 16">
                                        <path
                    ...
                    <div class="col-12 col-sm-4 col-add-post">
                        <a href="<?= adminUrl('add-post?type=audio'); ?>">
                            <div class="item">
                                <div class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="<?= $activeTheme->theme_color; ?>" class="bi bi-music-note-beamed"
                                        viewBox="0 0 16 16">
                                        <path
                    ...
                    <div class="col-12 col-sm-4 col-add-post">
                        <a href="<?= adminUrl('add-post?type=trivia_quiz'); ?>">
                            <div class="item">
                                <div class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="<?= $activeTheme->theme_color; ?>" class="bi bi-ui-checks-grid"
                                        viewBox="0 0 16 16">
                                        <path
                    ...
                    <div class="col-12 col-sm-4 col-add-post">
                        <a href="<?= adminUrl('add-post?type=personality_quiz'); ?>">
                            <div class="item">
                                <div class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="<?= $activeTheme->theme_color; ?>" class="bi bi-ui-checks"
                                        viewBox="0 0 16 16">
                                        <path
                    ...
                    <div class="col-12 col-sm-4 col-add-post">
                        <a href="<?= adminUrl('add-post?type=poll'); ?>">
                            <div class="item">
                                <div class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="<?= $activeTheme->theme_color; ?>" class="bi bi-ui-radios-grid"
                                        viewBox="0 0 16 16">
                                        <path
