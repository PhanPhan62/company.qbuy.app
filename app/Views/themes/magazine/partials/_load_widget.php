...
<div class="sidebar-widget">
    ...
    <div class="widget-body">
        <div class="row gx-3 widget-follow">
            ...
            <div class="col-sm-3 col-md-6 item"><a class="color-<?= esc($socialLink['key']); ?>"
                    href="<?= $socialLink['url']; ?>" target="_blank"><i
                        class="icon-<?= esc($socialLink['key']); ?>"></i><span><?= esc($socialLink['name']); ?></span></a>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
