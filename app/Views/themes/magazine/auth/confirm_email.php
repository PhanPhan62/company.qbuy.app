        ...
        <div class="row">
            <div class="page-confirm">
                ...
                <div class="text-center mb-3">
                    <svg enable-background="new 0 0 512 512" height="64px" id="Layer_1" version="1.1"
                        viewBox="0 0 512 512" width="64px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="text-center mb-3">
                    <svg enable-background="new 0 0 512 512" height="64px" viewBox="0 0 512 512" width="64px"
