                ...
                <div class="display-flex align-items-center justify-content-center">
                    <div class="section-account">
                        ...
                        <form action="<?= base_url('register-post'); ?>" method="post" class="needs-validation">
                            ...
                            <div class="mb-2">
                                <input type="text" name="username" class="form-control form-input input-account"
                                    placeholder="<?= trans("username"); ?>" value="<?= old("username"); ?>" required
                                    autocomplete="off">
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-3">
                                <input type="password" name="confirm_password"
                                    class="form-control form-input input-account"
                            ...
                            <div class="row">
                                <div class="col-sm-12 m-t-15">
                                    <button type="submit"
                                        class="btn btn-custom btn-account"><?= trans("register"); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
