                ...
                <div class="display-flex align-items-center justify-content-center">
                    <div class="section-account">
                        ...
                        <form action="<?= base_url('reset-password-post'); ?>" method="post" class="needs-validation">
                            ...
                            <div class="mt-3">
                                <a href="<?= langBaseUrl(); ?>"
                                    class="btn btn-custom btn-account"><?= trans("btn_goto_home"); ?></a>
                            </div>
                            <?php else: ?>
                            <div class="mb-3">
                                <input type="password" name="password" class="form-control form-input"
                                    value="<?= old("password"); ?>" placeholder="<?= trans("new_password"); ?>"
                                    required>
                            </div>
                            <div class="mb-3">
                                <input type="password" name="password_confirm" class="form-control form-input"
                                    value="<?= old("password_confirm"); ?>"
                                    placeholder="<?= trans("confirm_password"); ?>" required>
                            </div>
                            <div class="mb-3">
                                <button type="submit"
                                    class="btn btn-custom btn-account"><?= trans("btn_submit"); ?></button>
                            </div>
                            <?php endif; ?>
                        </form>
                    </div>
