                    ...
                    <div class="col-sm-12 col-md-9">
                        <div class="d-flex justify-content-center gap-5 earnings-box-container">
                            <div class="earnings-box justify-content-between">
                                ...
                                <div class="flex-column">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#4bc0c0"
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $earning->count; ?></td>
                                                <td><?= priceFormatted($earning->total_amount, getRewardPriceDecimal()); ?>
                                                </td>
                                            </tr>
                                            <?php endif;
                                                endif;
                                        ...
                                        yAxes: [{
                                            ticks: {
                                                ...
                                                callback: function(label, index, labels) {
                                                    return "<?= esc($generalSettings->currency_symbol); ?>" +
                                                        label.toFixed(4);
                                                }
                                            }
                                        }]
