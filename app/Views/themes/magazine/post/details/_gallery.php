...
<div class="gallery-post-item">
    ...
    <div class="post-image">
        <div class="post-image-inner">
            <img src="<?= $imgBaseURL . $galleryPostItem->image_large; ?>" alt="<?= esc($galleryPostItem->title); ?>"
                class="img-fluid" width="856" height="570" />
        </div>
    ...
    <div class="d-flex justify-content-between mb-5 mt-5">
        <div class="item">
            <?php if ($pageNumber != 1): ?>
            <a href="<?= generatePostURL($post); ?>?p=<?= $pageNumber - 1; ?>" class="btn btn-md btn-custom"><i
                    class="icon-arrow-left"></i>&nbsp;&nbsp;<?= trans("previous"); ?></a>
            <?php endif; ?>
        </div>
        <div class="item">
            <?php if ($pageNumber < $galleryPostNumRows): ?>
            <a href="<?= generatePostURL($post); ?>?p=<?= $pageNumber + 1; ?>"
                class="btn btn-md btn-custom"><?= trans("next"); ?>&nbsp;&nbsp;<i class="icon-arrow-right"></i></a>
            <?php endif; ?>
        </div>
    </div>
</div>
