<div class="d-flex mb-4">
    <div class="quiz-container">
        ...
        <div id="quiz_question_<?= $question->id; ?>" class="quiz-question"
                        ...
                        <div class="row row-answer">
                            ...
                            <div class="col-xs-12 col-sm-4 col-answer answer-format-image">
                                <div id="question_answer_<?= $answer->id; ?>"
                                    class="answer answer_<?= $post->post_type; ?>" data-post-id="<?= $post->id; ?>"
                                    data-question-id="<?= $question->id; ?>" data-answer-id="<?= $answer->id; ?>"
                                    data-answer-assigned-id="<?= $answer->assigned_result_id; ?>">
