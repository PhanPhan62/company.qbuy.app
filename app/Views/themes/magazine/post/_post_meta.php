...
<a href="<?= generateProfileURL($postItem->author_slug); ?>"
  class="a-username"><?= esc(characterLimiter($postItem->author_username, 7, '...')); ?></a>
<?php endif;
...
<span class="m-r-0"><i
    class="icon-eye"></i>&nbsp;<?= isset($postItem->pageviews_count) ? $postItem->pageviews_count : $postItem->pageviews; ?></span>
<?php endif; ?>