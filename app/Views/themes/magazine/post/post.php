            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="<?= generateCategoryURL($item); ?>"><?= esc($item->name); ?></a></li>
                    <?php endif;
                        endforeach;
                    endif; ?>
        ...
        .hidden-on-large {
                display: none;
                    ...
                    <div class="d-flex flex-row-reverse mt-4">
                        <a href="<?= esc($post->optional_url); ?>" class="btn btn-md btn-custom btn-icon"
                    ...
                    <div class="d-flex about-author">
                        <div class="flex-shrink-0">
                            <a href="<?= generateProfileURL($postUser->slug); ?>" class="author-link">
                                <img src="<?= getUserAvatar($postUser->avatar); ?>"
                                    alt="<?= esc($postUser->username); ?>" class="img-fluid img-author" width="110"
                                    height="110">
                            </a>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="social">
                                <ul class="profile-social-links">
                                    ...
                                    <li><a href="<?= langBaseUrl('rss/author/' . $postUser->slug); ?>"><i
                            ...
                            <div class="col-12">
                                <div class="nav nav-tabs" id="navTabsComment" role="tablist">
                                    ...
                                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#navComments"
                                        type="button" role="tab"><?= trans("comments"); ?></button>
                                    <?php endif;
                                        if ($generalSettings->facebook_comment_active == 1): ?>
                                    <button
                                        class="nav-link <?= $generalSettings->comment_system != 1 ? 'active' : ''; ?>"
                                ...
                                <div class="tab-content" id="navTabsComment">
                                    ...
                                    <div class="tab-pane <?= $generalSettings->comment_system != 1 ? 'active' : 'fade'; ?>"
                                        ...
                                        <div id="div_fb_comments" class="fb-comments"
                                            data-href="<?= currentFullURL(); ?>" data-width="100%" data-numposts="5"
