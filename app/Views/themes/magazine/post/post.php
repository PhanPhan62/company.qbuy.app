      ...
      <div class="col-md-12 col-lg-8">
        ...
        <div class="post-content">
          <div class="animation-container">
            <img id="animatedImage" style="height: 130px; width: auto"
              src="https://company.qbuy.app/uploads/images/202406/temp_666bf7710a4607-04615846.png" alt="Moving Image">
          ...
          <div class="d-flex align-items-center post-details-meta mb-4">
            ...
            <div class="item-meta item-meta-author">
              <a href="<?= generateProfileURL($postUser->slug); ?>"><img src="<?= getUserAvatar($postUser->avatar); ?>"
            ...
            <?php else: ?>
            <div class="item-meta item-meta-date">
              <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-clock"
                viewBox="0 0 16 16">
          ...
          <div class="d-flex flex-row-reverse mt-4">
            <a href="<?= esc($post->optional_url); ?>" class="btn btn-md btn-custom btn-icon" target="_blank"
              rel="nofollow">
              <?= esc($baseSettings->optional_url_button_name); ?>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="m-l-5"
                viewBox="0 0 16 16">
                <path fill-rule="evenodd"
          ...
          <?php endif; ?>
          <div class="d-flex flex-row post-tags align-items-center mt-3">
          ...
          <div class="post-next-prev mt-3 d-none">
            <div class="row">
              <div class="col-sm-6 col-xs-12 left">
                ...
                <h3 class="title text-end">
                  <a
                    href="<?= generatePostURL($previousPost); ?>"><?= esc(characterLimiter($previousPost->title, 80, '...')); ?></a>
                </h3>
                <?php endif; ?>
              </div>
              <div class="col-sm-6 col-xs-12 right">
                ...
                <h3 class="title text-start">
                  <a
                    href="<?= generatePostURL($nextPost); ?>"><?= esc(characterLimiter($nextPost->title, 80, '...')); ?></a>
                </h3>
                <?php endif; ?>
              </div>
            </div>
          ...
          <div class="d-flex about-author">
            ...
            <div class="flex-grow-1 ms-3">
              <strong class="username"><a href="<?= generateProfileURL($postUser->slug); ?>">
                  <?= esc($postUser->username); ?> </a></strong>
              ...
              <div class="social">
                <ul class="profile-social-links">
                  ...
                  <li><a href="<?= $socialLink['url']; ?>" target="_blank"><i
                        class="icon-<?= esc($socialLink['key']); ?>"></i></a></li>
                  <?php endforeach;
          ...
          <section class="section section-comments mt-3">
            <div class="row">
              <div class="col-12">
                <div class="nav nav-tabs" id="navTabsComment" role="tablist">
                  <?php if ($generalSettings->comment_system == 1): ?>
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#navComments" type="button"
                    role="tab"><?= trans("comments"); ?></button>
                  <?php endif;
                                        if ($generalSettings->facebook_comment_active == 1): ?>
                  <button class="nav-link <?= $generalSettings->comment_system != 1 ? 'active' : ''; ?>"
                    data-bs-toggle="tab" data-bs-target="#navFacebookComments" type="button"
                    role="tab"><?= trans("facebook_comments"); ?></button>
                  <?php endif; ?>
                </div>
                <div class="tab-content" id="navTabsComment">
                  ...
                  <?php endif;
                                        if ($generalSettings->facebook_comment_active == 1): ?>
                  <div class="tab-pane <?= $generalSettings->comment_system != 1 ? 'active' : 'fade'; ?>"
                    id="navFacebookComments" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <div id="div_fb_comments" class="fb-comments" data-href="<?= currentFullURL(); ?>" data-width="100%"
                      data-numposts="5" data-colorscheme="<?= $darkMode == 1 ? 'dark' : 'light'; ?>"></div>
                    <script>
                    document.getElementById("div_fb_comments").setAttribute("data-href", window
                      .location.href);
                    </script>
                  </div>
                  <?php endif; ?>
          ...
          <section class="section section-related-posts mt-3">
            <div class="row">
              <div class="col-12">
                      ...
                      <div class="post-item<?= checkPostImg($item, 'class'); ?>">
                        ...
                        <div class="image ratio">
                          <a href="<?= generatePostURL($item); ?>" <?php postURLNewTab($item); ?>>
                            <img src="<?= IMG_BASE64_450x280; ?>" data-src="<?= getPostImage($item, 'mid'); ?>"
                              alt="<?= esc($item->title); ?>" class="img-fluid lazyload" width="269" height="160" />
                            <?php getMediaIcon($item, 'media-icon'); ?>
                          </a>
                        </div>
                        <?php endif; ?>
                        <h3 class="title fsize-16"><a href="<?= generatePostURL($item); ?>"
                            <?php postURLNewTab($this, $item); ?>><?= esc(characterLimiter($item->title, 55, '...')); ?></a>
                        </h3>
                        <p class="small-post-meta">
                          <?= loadView('post/_post_meta', ['postItem' => $item]); ?></p>
                      </div>
                    </div>
                    <?php endif;
                                                $i++;
