                                ...
                                if ($item->item_type == "category"):
                                    ...
                                    if (!empty($category)): ?>
                                        <li class="nav-item nav-item-category nav-item-category-<?= $category->id; ?>" data-category-id="<?= $category->id; ?>">
                                            <a href="<?= generateCategoryURL($category); ?>" class="nav-link" data-toggle="dropdown" role="button" aria-expanded="false">
                                    ...
                                    if (!empty($subLinks)): ?>
                                        <li class="nav-item dropdown">
                                            <a class="nav-link" href="<?= generateMenuItemURL($item, $baseCategories); ?>">
                                    ...
                                    <?php else: ?>
                                        <li class="nav-item <?= uri_string() == $item->item_slug ? 'active' : ''; ?>">
                                            <a href="<?= generateMenuItemURL($item, $baseCategories); ?>" class="nav-link">
                                                <?= esc($item->item_name); ?>
                                            </a>
                                        </li>
                                    <?php endif;
                                ...
                                foreach ($baseMenuLinks as $item):
                                    if ($item->item_visibility == 1 && $item->item_location == "main" && $item->item_parent_id == "0"):
                                        if ($i >= $menuLimit):
                                            ...
                                            if (!empty($subLinks)): ?>
                                                <li>
                                                    <a href="<?= generateMenuItemURL($item, $baseCategories); ?>" class="dropdown-item display-flex align-items-center">
                                                        <?= esc($item->item_name); ?><i class="icon-arrow-down"></i>
                                                    </a>
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                            <div class="col-sm-2 menu-post-item<?= $postLimit == 5 ? ' width20' : ' width25'; ?>">
                                                                ...
                                                                <?php endif; ?>
                                                                <h3 class="title"><a href="<?= generatePostURL($item); ?>" <?php postURLNewTab($item); ?>>
