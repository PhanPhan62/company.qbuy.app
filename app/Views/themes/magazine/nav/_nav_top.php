            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto align-items-center">
                ...
                <li class="nav-item dropdown profile-dropdown display-flex align-items-center">
                    <a href="#" class="nav-link dropdown-toggle display-flex align-items-center" role="button"
                        ...
                        <img src="<?= getUserAvatar(user()->avatar); ?>" alt="<?= esc(user()->username); ?>" width="28"
                            height="28">&nbsp;
                        <?= esc(user()->username); ?>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?= adminUrl(); ?>"
                                class="dropdown-item"><?= user()->role == "admin" || user()->role == "moderator" ? trans("admin_panel") : trans("dashboard"); ?></a>
                        </li>
                        <?php endif; ?>
