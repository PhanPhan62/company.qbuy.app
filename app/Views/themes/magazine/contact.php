          ...
          <div class="col-sm-12 col-md-6">
            <div class="form-contact">
              ...
              <form action="<?= base_url('contact-post'); ?>" method="post" class="needs-validation">
                <?= csrf_field(); ?>
                <div class="mb-3">
                  <input type="text" class="form-control form-input" name="name" placeholder="<?= trans("name"); ?>"
                    maxlength="199" minlength="1" pattern=".*\S+.*" value="<?= old('name'); ?>" required>
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control form-input" name="email" maxlength="199"
                    placeholder="SĐT/<?= trans("email"); ?>" value="<?= old('email'); ?>" required>
                </div>
                <div class="mb-3">
                  <textarea class="form-control form-input" name="message" placeholder="<?= trans("message"); ?>"
                    maxlength="4970" minlength="5" required><?= old('message'); ?></textarea>
                </div>
                <div class="mb-3 form-check">
                  ...
                  <label class="form-check-label" for="checkboxContactTerms">
                    <?= trans("terms_conditions_exp"); ?>&nbsp;<a
                      ...
                      class="font-weight-600" target="_blank"><strong><?= trans("terms_conditions"); ?></strong></a>
                  </label>
                </div>
                <div class="mb-3">
  ...
  <div class="row">
    <div class="contact-map-container">
      <iframe id="contact_iframe"
        src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=<?= $baseSettings->contact_address; ?>&ie=UTF8&t=&z=8&iwloc=B&output=embed&disableDefaultUI=true"
