      ...
      <div class="box box-primary">
            ...
            <table class="table no-margin">
              ...
              <tbody>
                ...
                <tr>
                  <td><?= esc($item->id); ?> </td>
                  <td><?= esc($item->name); ?></td>
                  <td style="width: 60%" class="break-word1" style="text-align: center !important;">
                    <?= truncateString(esc($item->comment), 150); ?></td>
        ...
        <div class="box-footer clearfix">
          <a href="<?= adminURL('comments'); ?>"
            class="btn btn-sm btn-default btn-flat pull-right"><?= trans("view_all"); ?></a>
        </div>
      </div>
    </div>
    <?php else: ?>
            ...
            <table class="table no-margin">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= esc($item->name); ?></td>
                  <td style="width: 60%" class="break-word1" style="text-align: center !important;">
                    <?= truncateString(esc($item->comment), 150); ?>
                  </td>
                  <td class="nowrap"><?= formatDate($item->created_at); ?></td>
                </tr>
                <?php endforeach;
      ...
      <div class="box box-primary">
            ...
            <table class="table no-margin">
              ...
              <tbody>
                ...
                <tr>
                  <td><?= esc($item->id); ?></td>
                  <td>
                    <a href="<?= adminURL('contact-messages'); ?>"> <?= esc($item->name); ?> </a>
                  </td>
                  <td> <?= is_Email_Customer(esc($item->email)) ?> </td>
                  <td style="width: 60%" class="break-word1" style="text-align: center !important;">
                    <?= truncateString(esc($item->message), 30); ?></td>
        ...
        <div class="box-footer clearfix">
          <a href="<?= adminURL('contact-messages'); ?>"
            class="btn btn-sm btn-default btn-flat pull-right"><?= trans("view_all"); ?>
          </a>
        </div>
      </div>
    </div>
